...
public class DriveBaseTele extends Command {
  ...
  private void driveControls(){
    ...
    double stick = RobotUtil.scale(Robot.OI.getDriverRawAxis(RobotMap.LEFT_STICK_X), RobotMap.TURNING_RATE);

    Robot.driveTrain.percentOutput(triggerVal + stick, triggerVal - stick);
  }
